            ...
            if (index === paths.length - 1) {
                ...
                return {
                    ...
                    minify: (function () {
                        ...
                        if (
                            paths.length <=
                            (document.body.clientWidth > 800 ? 5 : 4)
                        ) {
                            return false;
                        }
                        if (
                            ...
                            return (
                                ...
                                >
                                    <Path
                                        ...
                                        path={path}
                                        isLast={
                                            this.state.path.length === index + 1
                                        }
...
const Logout = (props) => {
    ...
    return (
        <div className="li component_logout">
            {isRunningFromAnIframe ? null : CONFIG["logout"] ? (
...
const Saving = (props) => {
    return (
        <TransitionGroup>
            ...
            >
                <NgIf
                    key={props.needSaving}
                    className="component_saving"
