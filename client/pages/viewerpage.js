...
import { BreadCrumb, Bundle, NgIf, Loader, EventReceiver, LoggedInOnly, ErrorPage } from "../components/";
...
export class ViewerPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            url: null,
            filename: Path.basename(decodeURIComponent(props.match.url.replace("/view", ""))) || "untitled.dat",
            opener: null,
            content: null,
            needSaving: false,
            isSaving: false,
